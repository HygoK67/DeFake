            ...
            >
              ...
              <div class="file-info">
                ...
                <div class="file-meta">
                  ...
                  <!-- 显示文件元数据状态的标记 -->
                  <span
                    v-if="validateMetadata(fileItem.metadata)"
                    class="has-metadata"
                    >元数据完整</span
                  >
        ...
        <div v-if="selectedFile" class="metadata-content">
          ...
          <form class="metadata-form" @submit.prevent="saveMetadata">
            ...
            <div class="form-group">
              <label for="title"
                >文档标题 <span class="required">*</span></label
              >
              <input
                id="title"
            ...
            <div class="form-group">
              ...
              <input
                id="author"
                v-model="currentMetadata.author"
                type="text"
                placeholder="输入作者姓名"
            ...
            <div class="form-group">
              <label for="institution"
                >机构 <span class="required">*</span></label
              >
              <input
                id="institution"
                v-model="currentMetadata.institution"
                type="text"
            ...
            <div class="form-group">
              <label for="publishDate"
                >发布日期 <span class="required">*</span></label
              >
              <input
                id="publishDate"
                v-model="currentMetadata.publishDate"
                type="date"
            ...
            <div class="form-group">
              <label for="keywords"
                >关键词 <span class="required">*</span></label
              >
              <input
                id="keywords"
                v-model="currentMetadata.keywords"
                type="text"
            ...
            <div class="form-group">
              <label for="description"
                >文档描述 <span class="required">*</span></label
              >
              <textarea
                id="description"
                v-model="currentMetadata.description"
